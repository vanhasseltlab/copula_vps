...
ggsave(file = "results/figures/manuscript/FS3_full_copula_density_MIMIC.pdf", plot_distributions_mimic, width = 12, height = 12, units = "in", scale = 70/12, limitsize = FALSE)
